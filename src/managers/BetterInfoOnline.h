...
public:
	...
	std::map<std::pair<LeaderboardType, LeaderboardStat>, Ref<cocos2d::CCArray>> m_globalScoreDict;
	...
	arc::Future<CCArray*> loadGlobalScores(LeaderboardType type, LeaderboardStat stat, bool force);
};